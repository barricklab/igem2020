...
time = input("Enter time duration for simulaiton: ")
run_num = 0
...
for i in range(96):
    ...
    command = "python3 " + "$WORK/src/igem2020/T7-simulation/" + model + " -i " + genome_filename + " -o " + output_prefix + "_" + str(run_num) + " -t " + str(time) + " -s " + str(seed) + " -r\n"
    f.write(command)
